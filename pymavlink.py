...
class MAVLink_huch_sensor_array_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 212, struct.pack('<Q16dB', self.usec, self.data, self.subid))
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_HUCH_SENSOR_ARRAY : ( '<Q16dB', MAVLink_huch_sensor_array_message, [0, 2, 1], 212 ),
