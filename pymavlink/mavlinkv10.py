...
Generated from: huch.xml,common.xml,ardupilotmega.xml
...
class MAVLink_huch_sensor_array_message(MAVLink_message):
        ...
        '''
        def __init__(self, usec, data):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_HUCH_SENSOR_ARRAY, 'HUCH_SENSOR_ARRAY')
                self._fieldnames = ['usec', 'data']
                self.usec = usec
                self.data = data

        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 247, struct.pack('<Q16d', self.usec, self.data))
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_HUCH_SENSOR_ARRAY : ( '<Q16d', MAVLink_huch_sensor_array_message, [0, 1], 247 ),
...
class MAVLink(object):
        ...
        def huch_sensor_array_encode(self, usec, data):
                '''
                Generic sensor readings packed in locally defined order
                ...
                '''
                msg = MAVLink_huch_sensor_array_message(usec, data)
                msg.pack(self)
                return msg
            
        def huch_sensor_array_send(self, usec, data):
                '''
                Generic sensor readings packed in locally defined order
                ...
                '''
                return self.send(self.huch_sensor_array_encode(usec, data))
